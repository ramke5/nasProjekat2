...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            <h3 class="page-title">
                Izmijeni podatke o laboratoriji
                <small></small>
            </h3>
            ...
            <ul class="breadcrumb">
                ...
                <li>Izmijeni podatke o laboratoriji</li>
            </ul>
        </div>
    </div>
    <div id="dashboard">
        <div class="row-fluid">
            <div class="span12">
                <form:form id="form" method="post" modelAttribute="lab" class="form-horizontal">
                    <fieldset>
                        <legend id="lab_details">Podaci o laboratoriji: ${lab.name}</legend>
                        <div id="lab-contact">
                            <div class="span6">
                                <f:hidden path="id" />
                    ...
                    <div class="form-actions clearfix">
	                    <p>
	                        ...
	                        <a href="/lab/list" class="btn btn-primary grey"><i class="icon-remove-sign"></i> Poništi sve izmjene</a>
	                    </p>
                    </div>
                </form:form>
            </div>
