        ...
        <div class="row-fluid">
            <div class="span12">
                <form:form id="form" method="post" modelAttribute="lab" class="form-horizontal">
                    ...
                    <p>
                        <button type="submit" class="btn btn-primary blue"><i class="icon-ok-sign"></i> Spasi laboratoriju</button>
                        <a href="/lab/list" class="btn btn-primary grey"><i class="icon-remove-sign"></i> Odustani</a>
                    </p>
                        </div>
                </form:form>
