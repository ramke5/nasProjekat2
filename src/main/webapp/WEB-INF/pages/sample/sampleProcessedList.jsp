    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="breadcrumb">
                ...
                <li>Evidencija obrađenih uzoraka</li>
            </ul>
        </div>
    </div>
    <div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <display:table list="${data}" uid="row" class="table" sort="external" requestURI="" partialList="true" size="${total}" pagesize="10">
                        ...
                        <display:column title="Datum obrade" sortable="true" sortName="completedDate"> <fmt:formatDate type="date" value="${row.completedDate}" /> </display:column>
                        ...
                        <display:column >  <i class="icon-edit icon-grey"></i>
                            <a href="/sample/print/${row.id}"> Printaj nalaz</a></display:column>
                    </display:table>
                    </div>
                </div>
            </div>
