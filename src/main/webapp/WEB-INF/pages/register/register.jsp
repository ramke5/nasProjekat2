...
<div class="container min-hight">
	<div class="content signupform">
		...
		<div class="row-fluid">
			...
			<div class="span11">
				<h4>
					Register below for a free nalaz account.
					<br/>
...
<%-- 					<f:hidden path="user.stripeUser"/> --%>
					...
					<f:input path="user.phoneNumber" label="Phone number"></f:input>
	        ...
	        <div class="form-actions">
				...
				<div class="span6">
	            	<button type="submit" class="btn blue">Submit <i class="m-icon-swapright m-icon-white"></i></button>
				</div>
	        </div>
		</form:form>
	</div>
...
<script>
    $(document).ready(function () {        
    	$("#form").submit(function(event) {
    		document.getElementById("user.username").value = document.getElementById("user.email").value;
		});
    });
</script>
